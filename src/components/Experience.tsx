  ...
  const getColorClasses = (color: string) => {
    const colorMap = {
      yellow: {
        ...
        glow:
          theme === "dark" ? "shadow-yellow-500/20" : "shadow-yellow-200/50",
      },
      blue: {
      ...
      amber: {
        ...
        glow: theme === "dark" ? "shadow-amber-500/20" : "shadow-amber-200/50",
      },
    };
                      ...
                      <motion.div
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-medium border ${
                          exp.category === "technical"
                            ? theme === "dark"
                              ? "bg-gradient-to-r from-blue-900/40 to-indigo-900/30 text-blue-400 border-blue-500/40 shadow-blue-500/20"
                              : "bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 border-blue-200 shadow-blue-200/50"
                            : theme === "dark"
                            ? "bg-gradient-to-r from-purple-900/40 to-pink-900/30 text-purple-400 border-purple-500/40 shadow-purple-500/20"
                            : "bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 border-purple-200 shadow-purple-200/50"
                        } flex items-center gap-2 shadow-lg backdrop-blur-sm transition-all duration-200`}
                      >
                        {exp.category === "technical" ? (
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm">
                          <motion.div
                            ...
                            className={`px-4 py-2 rounded-full font-medium border ${
                              theme === "dark"
                                ? "bg-gradient-to-r from-indigo-900/40 to-purple-900/30 text-indigo-300 border-indigo-500/30 shadow-indigo-500/20"
                                : "bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border-indigo-200 shadow-indigo-200/50"
                        ...
                        {exp.highlights.map((highlight, hIndex) => (
                          <motion.span
                            ...
                            className={`px-4 py-2 text-sm rounded-full border ${
                              theme === "dark"
                                ? "bg-gradient-to-r from-gray-700/60 to-gray-800/60 text-gray-300 border-gray-600/60 hover:border-gray-500/80 shadow-gray-500/20"
                                : "bg-gradient-to-r from-gray-50 to-white text-gray-700 border-gray-200 hover:border-gray-300 shadow-gray-200/50"
                            } flex items-center gap-2 shadow-lg backdrop-blur-sm transition-all duration-200`}
                          >
                        ...
                        {exp.technologies.map((tech, techIndex) => (
                          <motion.span
                            ...
                            className={`px-4 py-2 text-sm rounded-xl font-medium border ${
                              theme === "dark"
                                ? "bg-gradient-to-r from-indigo-900/50 to-blue-900/40 text-indigo-300 border-indigo-500/30 hover:border-indigo-400/50 shadow-indigo-500/20"
                                : "bg-gradient-to-r from-indigo-50 to-blue-50 text-indigo-700 border-indigo-200 hover:border-indigo-300 shadow-indigo-200/50"
                            } shadow-lg backdrop-blur-sm transition-all duration-200`}
                          >
                            {tech}
                          </motion.span>
                      ...
                      >
                        <motion.div
                          ...
                          className={`px-3 py-1.5 rounded-full text-xs font-bold border backdrop-blur-md ${
                            theme === "dark"
                              ? "bg-gradient-to-r from-indigo-900/60 to-purple-900/50 text-indigo-300 border-indigo-500/40 shadow-indigo-500/30"
                              : "bg-gradient-to-r from-indigo-100/80 to-purple-100/80 text-indigo-700 border-indigo-300/50 shadow-indigo-200/50"
                    ...
                    >
                      ...
                      <div className="flex items-start gap-4">
                        <motion.div
                          ...
                          className={`p-4 rounded-2xl ${colorClasses.bg} border ${colorClasses.border} ${colorClasses.glow} shadow-lg backdrop-blur-sm`}
                        >
                          ...
                          <div className="flex flex-wrap justify-between items-start gap-2 mb-3">
                            ...
                            <motion.span
                              ...
                              className={`text-xs px-3 py-1.5 rounded-full font-medium border ${
                                theme === "dark"
                                  ? "bg-gradient-to-r from-indigo-900/50 to-blue-900/40 text-indigo-300 border-indigo-500/30 shadow-indigo-500/20"
                                  : "bg-gradient-to-r from-indigo-100 to-blue-100 text-indigo-700 border-indigo-200 shadow-indigo-200/50"
                              } shadow-lg backdrop-blur-sm transition-all duration-200`}
                            >
                              {achievement.year}
                            </motion.span>
